...
<%
	...
	String sql3 = "select goods_no, category, goods_title, filename, goods_content, goods_price, goods_amount, update_date from goods where category = ? order by goods_no desc limit ?, ?";
...
<%
	...
	String sql1 = "select goods_no, category, goods_title, filename, goods_content, goods_price, goods_amount, update_date from goods order by goods_no desc limit ?, ?";
...
<div class="container">
	...
	<table class="table table-hover">
		...
		<div>애니 종류</div><br>
			...
			%>
			<tr>
				<td><a href="/shop/customer/customerGoodsOne.jsp?goods_no=<%=(Integer)(m1.get("goods_no"))%>"><%=(Integer)(m1.get("goods_no"))%></a></td>
		...
		%>
				<tr>
				<td><a href="/shop/customer/customerGoodsOne.jsp?goods_no=<%=(Integer)(m3.get("goods_no"))%>"><%=(Integer)(m3.get("goods_no"))%></a></td>
